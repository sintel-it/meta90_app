...
def main():
    ...
    run([py, "-m", "py_compile", "scripts/check_google_oauth.py", "scripts/preflight_oauth_and_env.py", "scripts/sqlite_to_postgres.py"])
    ...
    run([py, "scripts/preflight_oauth_and_env.py"])
    run([py, "-m", "pytest", "-q"])
